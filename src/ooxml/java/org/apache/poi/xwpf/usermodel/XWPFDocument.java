...
/**
 * Experimental class to do low level processing of docx files. If you are using these low level classes, then you will
 * almost certainly need to refer to the OOXML specifications from
 * http://www.ecma-international.org/publications/standards/Ecma-376.htm WARNING - APIs expected to change rapidly
 */
public class XWPFDocument extends POIXMLDocument {
	...
	public XWPFParagraph[] getParagraphs() {
		return paragraphs.toArray(new XWPFParagraph[paragraphs.size()]);
	}
	...
	public void enforceReadonly() {
		...
		documentProtection.setEnforcement(  STOnOff.X_1 );
	}
